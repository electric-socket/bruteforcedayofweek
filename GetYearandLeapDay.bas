...
' Marking leap years by adding 10
Option _Explicit
Const Saturday = 0
...
Open "DayandLeapTable.bas" For Output As #1
Print "Creating DayandLeapTable.bas"
Print #1, "' DayandLeapTable.bas"
...
Print #1, "' Leap years are indicated by adding 10"
Print #1, "'"
